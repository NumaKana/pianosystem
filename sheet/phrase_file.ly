...
\override NoteHead.color = #(x11-color "LightSteelBlue")
    \repeat volta 2 {
        \repeat volta 2 {
            ...
            \stemDown\override NoteHead.color = #(x11-color "black")  e8 ( [ \stemDown c8 ] | % 7
            \stemDown d8 [ \stemDown b8 \stemDown c8 \stemDown a8 ]
            \stemUp b8 [ \stemUp g8 \stemUp a8 \stemUp fis8 ) ]  \override NoteHead.color = #(x11-color "LightSteelBlue") | % 8
